...
public class WorkbenchSystem : MonoBehaviour
{
    ...
    {
        if (StoreSystem.Instance == null) { return; }
        int[] store = StoreSystem.Instance.IdAll();
    ...
    private void Awake()/*******/
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            itemButtons[i] = GameObject.Find("WorkbenchCanvas/ItemStore/Item" + i);
        }
        itemButtons[4] = GameObject.Find("WorkbenchCanvas/ItemStore/UpPage");
        itemButtons[5] = GameObject.Find("WorkbenchCanvas/ItemStore/DownPage");
        for (int i = 0; i < 6; i++)
        {
            formulaButtons[i] = GameObject.Find("WorkbenchCanvas/Formula/Formula" + i);
        }
        formulaButtons[6] = GameObject.Find("WorkbenchCanvas/Formula/LeftPage");
        formulaButtons[7] = GameObject.Find("WorkbenchCanvas/Formula/RightPage");
        formulaButtons[8] = GameObject.Find("WorkbenchCanvas/Formula/MakeButton");
        #endregion 匹配按钮
        /***********/
        //formulaList[0][0] = 2;
        /***********/
