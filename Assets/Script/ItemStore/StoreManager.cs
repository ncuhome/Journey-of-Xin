...
public class StoreManager : MonoBehaviour
{
    ...
    public void UpdateStoreSystem()
    {
        ...
        int[] storeItem = StoreSystem.Instance.IdAll();
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            buttons[i] = GameObject.Find("Canvas (1)/Item" + i);
        }
        buttons[8] = GameObject.Find("Canvas (1)/LastPage");
        buttons[9] = GameObject.Find("Canvas (1)/NextPage");
