...
public class SecretNumberManager : MonoBehaviour
{
    ...
    public void Refresh()
    {
        if ((numbersState[0] == 1)&&(!StoreSystem.Find(16)))
        {
            StoreSystem.Add(16);
        }
        if ((numbersState[1] == 1)&&(!StoreSystem.Find(12)))
        {
            StoreSystem.Add(12);
        }
        if ((numbersState[2] == 1)&&(!StoreSystem.Find(26)))
        {
            StoreSystem.Add(26);
        }
        if ((numbersState[3] == 1)&&(!StoreSystem.Find(25)))
        {
            StoreSystem.Add(25);
        }
        if ((numbersState[4] == 1)&&(!StoreSystem.Find(27)))
        {
            StoreSystem.Add(27);
        }
    }
