...
public class EventSystem : MonoBehaviour, IEventList
{
    ...
    private void GetLastLetterAndMail()
    {
        ...
        StoreSystem.Instance.Add(5);
        StoreSystem.Instance.Add(6);
    ...
    {
        StoreSystem.Instance.Add(13);
    }

    private void GetCoffee()
    {
        StoreSystem.Instance.Add(2);
    }
    ...
    {
        StoreSystem.Instance.Add(22);
    }

    private void GetBlackMineral()
    {
        StoreSystem.Instance.Add(18);
    }
    private void GetPerspectiveGlass()
    {
        StoreSystem.Instance.Add(20);
    }
    private void GetEndlessEnergyMaker()
    {
        StoreSystem.Instance.Add(21);
    }
    ...
    {
        yield return new WaitForSeconds(2.5f);
        if (!StoreSystem.Instance.Find(2))
        {
    ...
    {
        if (StoreSystem.Instance.Find(24) || StoreSystem.Instance.Find(23))
        {
    ...
    private IEnumerator AfterCE9Fade()
    {
        yield return new WaitForSeconds(1f);
        InputManager.Instance.sceneState = SceneState.MainScene;
        if (StoreSystem.Instance.Find(13))
        {
    ...
    {
        if (StoreSystem.Instance.Find(23))
        {
